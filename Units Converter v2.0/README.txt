This is the 2.0 version of my Unit Converter. The major difference on the user side is the more simplified method of inputting a conversion. Now the user can just type "25 miles to feet" and press convert. In addition, the user can convert between composite units as well, such as miles per gallon or meters per second. As for the code itself, I hope this version follows proper programming practice and common OOP design concepts better than the previous versions. 
